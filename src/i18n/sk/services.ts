export default {
  help: {
    title: 'Služby, ktoré poskytujeme',
    body: 'Uľahčíme vám život a otvoríme dvere do svetlej budúcnosti pomocou obnoviteľných zdrojov a zelenej energie. Náš tím skúsených odborníkov sa vám bude s radosťou venovať od začiatku až do skončenia vášho projektu.',
    list: [
